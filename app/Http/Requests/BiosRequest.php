...
class BiosRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ru_aspirant'=>['required','string', 'min:4', 'max:500'],
            ...
            'en_univer'=>['required','string', 'min:4', 'max:500'],
            'en_intern'=>['required','string', 'min:4', 'max:500'],
            'en_aspirant'=>['required','string', 'min:4', 'max:500'],
            'en_departments'=>['required','string', 'min:4', 'max:3000'],
            'en_courses'=>['required','string', 'min:4', 'max:2000'],
            'en_practic_interes'=>['required','string', 'min:4', 'max:2000'],
            'en_research_interes'=>['required','string', 'min:4', 'max:255'],
            'en_society'=>['required','string', 'min:4', 'max:500'],
            'photo'=>['sometimes','file','mimes:png,jpg,bmp','dimensions:width=600,height=195'],
        ];
    }
}
